...
<div class="box-header with-border">
						<h3 class="box-title"><?php echo strtoupper($dept); ?>`<?php echo $result[0]; ?> Batch</h3>
    ...
    <?php 
				...
				?>
							...
							<td> <a data-toggle="modal" data-id='<?php echo $row["id"]; ?>' class="open-viewFacultyDialog" href="#viewFacultyDialog"><i class="fa fa-picture-o"></i></a> </td>
