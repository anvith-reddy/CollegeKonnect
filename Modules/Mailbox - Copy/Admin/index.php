        ...
        // fetching records
                            function trash(numRecords, pageNum) {
                                $.ajax({
                                    ...
                                    success: function(html) {
										document.getElementById("inbox").innerHTML = "";
										document.getElementById("sentmail").innerHTML = "";
										document.getElementById("archived").innerHTML = "";
                                        $("div#trash").html(html);
                                        $('.loader').html('');
                                    }
...
<div id="response"></div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>MAILBOX</b></h3>
              <div class="box-tools">
	...
	<section class="content">
      <div class="row">
        <div class="col-md-3">
		  <button type="button" class="btn btn-primary btn-block margin-bottom" id="compose">Compose</button>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="javascript:void(0);" onclick="inbox()"><i class="fa fa-inbox"></i> Inbox</a></li>
                <li><a href="javascript:void(0);" onclick="sentmail()"><i class="fa fa-envelope-o"></i> Sent</a></li>
                <li><a href="javascript:void(0);" onclick="archived()"><i class="fa fa-file-text-o"></i> Archives</a></li>
                <li><a href="javascript:void(0);" onclick="trash()"><i class="fa fa-trash-o"></i> Trash</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
...
<div class="box-tools">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="box-body table-responsive no-padding" id="inbox"></div><!-- /.table -->
				<div class="box-body table-responsive no-padding" id="sentmail"></div><!-- /.table -->
				<div class="box-body table-responsive no-padding" id="trash"></div><!-- /.table -->
				<div class="box-body table-responsive no-padding" id="archived"></div><!-- /.table -->
              </div>
              <!-- /.mail-box-messages -->
            </div>
            <!-- /.box-body -->
