...
$sql = "SELECT count(*) FROM events  WHERE scope='student' OR scope='local' OR scope='global'" ;
...
$sql2 = " SELECT * FROM events WHERE scope='student' OR scope='local' OR scope='global' order by posted_on DESC limit ". ($lower_limit)." ,  ". ($page_limit). " ";
